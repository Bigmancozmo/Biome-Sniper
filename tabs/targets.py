...
def create(notebook: ttk.Notebook):
	...
	add_keyword_toggle("KEYWORD_Jest", "Jester", True, Column.MERCHANT.value, 5)
	add_keyword_toggle("KEYWORD_Obliv", "Oblivion Potion", False, Column.MERCHANT.value, 6)
	add_keyword_toggle("KEYWORD_Rin", "Rin", False, Column.MERCHANT.value, 7)
